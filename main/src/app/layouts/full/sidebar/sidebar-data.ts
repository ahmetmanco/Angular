...
export const navItems: NavItem[] = [
  ...
  {
    displayName: 'Ev, Yaşam, Kırtasiye, Ofis',
  ...
  },
  {
    ...
    iconName: 'device-desktop', // Alternatif: 'icon-cpu', 'icon-device-tv'
    route: '/electronics',
    chip: true,
    external: false
  },
  {
    displayName: 'Spor',
    iconName: 'run', // Alternatif: 'icon-run', 'icon-dumbbell'
    route: '/sports',
    chip: true,
    external: false
  },
  {
    displayName: 'Anne - Çocuk - Bebek Bezi',
    iconName: 'ripple', // Alternatif: 'icon-pacifier'
    route: '/baby',
    chip: true,
    external: false
  },
  {
    ...
    iconName: 'brush', // Alternatif: 'icon-brush', 'icon-hand-cream'
    route: '/cosmetics',
    chip: true,
    external: false
  },
  {
    displayName: 'Kitap',
    iconName: 'notebook', // Alternatif: 'icon-books', 'icon-notebook'
    route: '/books',
    chip: true,
    external: false
  },
  {
    ...
    iconName: 'shopping-cart', // Alternatif: 'icon-basket', 'icon-building-store'
    route: '/supermarket',
    chip: true,
    external: false
  }
